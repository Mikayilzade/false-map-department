...
RECEIPT_SCHEMA = "fmd.phase12g.e8.completion-receipt.v1"
...
def write_receipt(root: Path, asset_set: dict[str, Any], respondents: dict[str, Any], completed_path: Path) -> Path:
    ...
    receipt = {
        ...
        "evidence_boundary": "Digest receipt binds the finalized respondent return to the exact immutable E8 asset/source/build packet; it is integrity metadata, not market evidence or an E8 disposition.",
    }
