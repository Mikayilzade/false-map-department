...
python3 scripts/phase12g_e11_semantic_binding_audit.py | tee "$OUT_DIR/e11-semantic-binding-audit.log"
python3 scripts/phase12g_e3_semantic_binding_audit.py | tee "$OUT_DIR/e3-semantic-binding-audit.log"
python3 scripts/phase12g_e4_semantic_binding_audit.py | tee "$OUT_DIR/e4-semantic-binding-audit.log"
python3 scripts/phase12g_e5_semantic_binding_audit.py | tee "$OUT_DIR/e5-semantic-binding-audit.log"
python3 scripts/phase12g_e6_semantic_binding_audit.py | tee "$OUT_DIR/e6-semantic-binding-audit.log"
python3 scripts/phase12g_e9_e10_finalization_binding_audit.py | tee "$OUT_DIR/e9-e10-finalization-binding-audit.log"
...
python3 scripts/phase12g_e8_finalization_binding_audit.py | tee "$OUT_DIR/e8-finalization-binding-audit.log"
...
python3 scripts/phase12g_reference_target_binding_audit.py | tee "$OUT_DIR/reference-profile-target-audit.log"
python3 scripts/phase12g_evidence_destination_binding_audit.py | tee "$OUT_DIR/evidence-destination-binding-audit.log"
