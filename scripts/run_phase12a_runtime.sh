...
run_logged phase12e-inspect-history-contract python3 scripts/phase12e_inspect_history_audit.py
...
run_logged phase12e-inspect-history-suite "$RESOLVED_GODOT" --headless --path . --script res://tests/test_phase12e_inspect_history_runner.gd
assert_no_script_errors phase12e-inspect-history-suite
run_logged phase12e-stability-ux-suite "$RESOLVED_GODOT" --headless --path . --script res://tests/test_phase12e_stability_ux_runner.gd
assert_no_script_errors phase12e-stability-ux-suite
run_logged phase12e-linked-layer-ux-suite "$RESOLVED_GODOT" --headless --path . --script res://tests/test_phase12e_linked_layer_ux_runner.gd
...
run_logged phase12f-transaction-history-adversarial-suite "$RESOLVED_GODOT" --headless --path . --script res://tests/test_phase12f_transaction_history_adversarial_runner.gd
assert_no_script_errors phase12f-transaction-history-adversarial-suite
run_logged phase12f-persistence-recovery-adversarial-suite "$RESOLVED_GODOT" --headless --path . --script res://tests/test_phase12f_persistence_recovery_adversarial_runner.gd
assert_no_script_errors phase12f-persistence-recovery-adversarial-suite
run_logged phase12f-profile-demo-adversarial-suite "$RESOLVED_GODOT" --headless --path . --script res://tests/test_phase12f_profile_demo_adversarial_runner.gd
...
write_manifest "PASS" ""
echo "Phase 12A + 12B + 12C + 12D + 12E + 12F runtime baseline: PASS"
